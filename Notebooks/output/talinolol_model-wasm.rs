...
pub struct SimulationParams {
    ...
    pub init_Cki_plasma_tal: Option<f64>,
    pub init_Cli_plasma_tal: Option<f64>,
    pub init_Clu_plasma_tal: Option<f64>,
    pub init_Cgu_plasma_tal: Option<f64>,
    pub init_Cre_plasma_tal: Option<f64>,
    pub init_Cfo_plasma_tal: Option<f64>,
    pub init_Car_tal: Option<f64>,
    pub init_Cve_tal: Option<f64>,
    pub init_Cpo_tal: Option<f64>,
    pub init_Chv_tal: Option<f64>,
    pub init_Cfov_tal: Option<f64>,
    pub init_Clu_tal: Option<f64>,
    pub init_Cre_tal: Option<f64>,
    pub init_Aurine_tal: Option<f64>,
    pub init_Afeces_tal: Option<f64>,
    pub init_Cduodenum_tal: Option<f64>,
...
pub fn run_simulation(params: &str) -> String {
    ...
    let FVre = 1.0_f64 - 1.0_f64*(FVfo + (FVar + (FVve + (FVlu + (FVli + (FVgu + FVki))))));
    let FQre = 1.0_f64 - 1.0_f64*(FQfo + (FQh + FQki));
    let BSA = 4853.0/200000.0*(BW*1.0_f64.powi(-1)).powf(2689.0/5000.0)*(HEIGHT*1.0_f64.powi(-1)).powf(991.0/2500.0);
    let CO = BW*COBW + 1.0/60.0*(HR - 1.0_f64*HRrest)*COHRI;
    let Vgu = BW*FVgu;
    let Vki = BW*FVki;
    let Vli = BW*FVli;
    let Vlu = BW*FVlu;
    let Vve = BW*FVve - 1.0_f64*FVve*(FVar + FVve).powi(-1)*BW*Fblood*(-1.0_f64*FVar + (1.0_f64 - 1.0_f64*FVve));
    let Var = BW*FVar - 1.0_f64*FVar*(FVar + FVve).powi(-1)*BW*Fblood*(-1.0_f64*FVar + (1.0_f64 - 1.0_f64*FVve));
    let Vpo = (1.0_f64 - 1.0_f64*HCT)*(BW*FVpo - 1.0_f64*FVpo*(FVfo + (FVhv + (FVpo + (FVar + FVve)))).powi(-1)*BW*Fblood*(1.0_f64 - 1.0_f64*(FVfo + (FVhv + (FVpo + (FVar + FVve))))));
    let Vhv = (1.0_f64 - 1.0_f64*HCT)*(BW*FVhv - 1.0_f64*FVhv*(FVfo + (FVhv + (FVpo + (FVar + FVve)))).powi(-1)*BW*Fblood*(1.0_f64 - 1.0_f64*(FVfo + (FVhv + (FVpo + (FVar + FVve))))));
    let Vfo_plasma = Vfo*Fblood*(1.0_f64 - 1.0_f64*HCT);
    let Vfo_tissue = Vfo*(1.0_f64 - 1.0_f64*Fblood);
    let Ki_tal = 693.0/1000.0*ti_tal.powi(-1)*60.0_f64;
    let Afov_tal = Cfov_tal*Vfov;
    let Xurine_tal = Aurine_tal*Mr_tal;
    let Xfeces_tal = Afeces_tal*Mr_tal;
    let Vre = BW*FVre;
    let QC = 1.0/1000.0*CO*60.0_f64;
    let Vgu_plasma = Vgu*Fblood*(1.0_f64 - 1.0_f64*HCT);
    let Vgu_tissue = Vgu*(1.0_f64 - 1.0_f64*Fblood);
    let Vki_plasma = Vki*Fblood*(1.0_f64 - 1.0_f64*HCT);
    let Vki_tissue = Vki*(1.0_f64 - 1.0_f64*Fblood);
    let Vli_plasma = Vli*Fblood*(1.0_f64 - 1.0_f64*HCT);
    let Vli_tissue = Vli*(1.0_f64 - 1.0_f64*f_tissue_loss)*(1.0_f64 - 1.0_f64*Fblood);
    let Vlu_plasma = Vlu*Fblood*(1.0_f64 - 1.0_f64*HCT);
    let Vlu_tissue = Vlu*(1.0_f64 - 1.0_f64*Fblood);
    ...
    let Vre_plasma = Vre*Fblood*(1.0_f64 - 1.0_f64*HCT);
    let Vre_tissue = Vre*(1.0_f64 - 1.0_f64*Fblood);
    let Qgu = QC*FQgu;
    let Qki = QC*FQki;
    let Qh = QC*FQh;
    let Qlu = QC*FQlu;
    ...
    let Mre_plasma_tal = Are_plasma_tal*Vre_plasma.powi(-1)*Mr_tal;
        ...
        let x7 = ftissue_tal*(-1.0_f64*Clu_plasma_tal*x6 + Clu_tal);
        let x8 = -1.0_f64*Clu_plasma_tal*Qlu;
        let x9 = 1.0*Qgu;
        let x10 = Car_tal*Qre;
        let x11 = ftissue_tal*(-1.0_f64*Cre_plasma_tal*x6 + Cre_tal);
        let x12 = Cre_plasma_tal*Qre;
        let x13 = Car_tal*f_shunting_forearm;
        let x14 = f_shunting_forearm - 1.0_f64;
        let x15 = Cfo_plasma_tal*x14;
        let x16 = 1.0*Qfo;
        let x17 = f_shunts*x2;
        let x18 = f_shunts - 1.0_f64;
        let x19 = Chv_tal*Qh;
        let x20 = f_shunts*x3;
        let x21 = 1.0*x18*x4;
        let x22 = 1.0*Qpo;
        ...
        // Derivatives
        dy[0] = x0*(Car_tal - 1.0_f64*Cki_plasma_tal);
        dy[1] = (x1 - 1.0)*(Cli_plasma_tal*x4 - 1.0_f64*x2 - 1.0_f64*x3);
        dy[2] = 1.0*x5 + 1.0*x7 + 1.0*x8;
        dy[3] = x9*(Car_tal - 1.0_f64*Cgu_plasma_tal);
        dy[4] = 1.0*x10 + 1.0*x11 - 1.0*x12;
        dy[5] = x16*(-1.0_f64*Car_tal*x14 - 1.0_f64*x13 + x15);
        ...
        dy[10] = x16*(-1.0_f64*Cfov_tal + x13 - 1.0_f64*x15);
        dy[11] = -1.0*x7;
        dy[12] = -1.0*x11;
        dy[13] = 0.0;
        dy[14] = 0.0;
    ...
    let Mre_plasma_tal = Are_plasma_tal*Vre_plasma.powi(-1)*Mr_tal;
        ...
        jv[4] += (x25) * v[12];
        jv[5] += (x27) * v[5];
        jv[5] += (-1.0_f64*x16*(2.0_f64*f_shunting_forearm - 1.0_f64)) * v[6];
        jv[6] += (x24) * v[2];
        jv[6] += (x27) * v[5];
        jv[6] += (1.0*Qfo*x14 - 1.0*Qgu - 1.0*Qha*f_shunts + 1.0*Qha*x18 - 1.0*Qki - 1.0*Qre - 1.0*x28) * v[6];
        jv[7] += (x0) * v[0];
        jv[7] += (x26) * v[4];
        jv[7] += (-1.0_f64*x24) * v[7];
        jv[7] += (x29) * v[9];
        jv[7] += (x16) * v[10];
        jv[8] += (x9) * v[3];
        jv[8] += (-1.0_f64*x22) * v[8];
        jv[9] += (-1.0_f64*x21) * v[1];
        jv[9] += (Qha*x1) * v[6];
        jv[9] += (Qpo*x1) * v[8];
        jv[9] += (-1.0_f64*x29) * v[9];
        jv[10] += (-1.0_f64*x27) * v[5];
        jv[10] += (1.0*x28) * v[6];
        jv[10] += (-1.0_f64*x16) * v[10];
        jv[11] += (x30) * v[2];
        jv[11] += (x31) * v[11];
        jv[12] += (x30) * v[4];
        jv[12] += (x31) * v[12];
    ...
    let init = |_y0: &diffsol::NalgebraVec<f64>, _t: f64, y: &mut diffsol::NalgebraVec<f64>| {
        y[0] = sim_params.init_Cki_plasma_tal.unwrap_or(0.0);
        y[1] = sim_params.init_Cli_plasma_tal.unwrap_or(0.0);
        y[2] = sim_params.init_Clu_plasma_tal.unwrap_or(0.0);
        y[3] = sim_params.init_Cgu_plasma_tal.unwrap_or(0.0);
        y[4] = sim_params.init_Cre_plasma_tal.unwrap_or(0.0);
        y[5] = sim_params.init_Cfo_plasma_tal.unwrap_or(0.0);
        y[6] = sim_params.init_Car_tal.unwrap_or(0.0);
        y[7] = sim_params.init_Cve_tal.unwrap_or(0.0);
        y[8] = sim_params.init_Cpo_tal.unwrap_or(0.0);
        y[9] = sim_params.init_Chv_tal.unwrap_or(0.0);
        y[10] = sim_params.init_Cfov_tal.unwrap_or(0.0);
        y[11] = sim_params.init_Clu_tal.unwrap_or(0.0);
        y[12] = sim_params.init_Cre_tal.unwrap_or(0.0);
        y[13] = sim_params.init_Aurine_tal.unwrap_or(0.0);
        y[14] = sim_params.init_Afeces_tal.unwrap_or(0.0);
        y[15] = sim_params.init_Cduodenum_tal.unwrap_or(0.0);
    };
...
pub fn get_parameters_info() -> String {
    let params = serde_json::json!([
        ...
        {
            "id": "f_shunting_forearm",
            "default_value": 0.28,
            "required": true
        },
        {
            "id": "FVgu",
            "default_value": 0.0171,
            "required": true
        },
        {
            "id": "FVki",
            "default_value": 0.0044,
            "required": true
        },
        {
            "id": "FVli",
        ...
        {
            "id": "FVfo",
            "default_value": 0.00482857142857143,
            "required": true
        },
        {
            "id": "FVve",
            "default_value": 0.0514,
            "required": true
        },
        {
            "id": "FVar",
            "default_value": 0.0257,
            "required": true
        },
        {
            "id": "FVpo",
        ...
        {
            "id": "FQfo",
            "default_value": 0.0146153846153846,
            "required": true
        },
        {
            "id": "conversion_min_per_day",
        ...
        {
            "id": "Ka_dis_tal",
            "default_value": 0.681894676931315,
            "required": true
        },
        {
            "id": "Mr_tal",
            "default_value": 363.495,
            "required": true
        },
        {
            "id": "fup_tal",
        ...
        {
            "id": "ftissue_tal",
            "default_value": 0.641324628334905,
            "required": true
        },
        {
            "id": "Kp_tal",
            "default_value": 6.62140199045977,
            "required": true
        },
        {
            "id": "IVDOSE_tal",
        ...
        {
            "id": "Vduodenum",
            "default_value": 0.322563025707332,
            "required": true
        }
    ]);
...
pub fn get_default_parameters() -> String {
    let defaults = serde_json::json!({
        ...
        "conversion_min_per_day": 1440.0,
        "f_cirrhosis": 0.0,
        "PODOSE_tal": 0.0,
        "Ka_dis_tal": 0.681894676931315,
        "Mr_tal": 363.495,
        "fup_tal": 0.4,
        "ftissue_tal": 0.641324628334905,
        "Kp_tal": 6.62140199045977,
        "IVDOSE_tal": 0.0,
        "ti_tal": 10.0,
        "Ri_tal": 0.0,
        "cum_dose_tal": 0.0,
        "cum_dose_intestine_tal": 0.0,
        "Vurine": 1.0,
        "Vfeces": 1.0,
        "Vstomach": 1.0,
        "Vfo": 1.0,
