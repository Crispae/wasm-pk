...
class Species:
    ...
    def compartment(self, compartment):
        warnings.warn(
            "Attempted to change species compartment after species instantiation. If you know what you are doing, change species._compartment."
        )
...
def Piecewise(*args):
    ...
    if len(args) % 2 == 1:
        ...
        raise Exception(
            "Piecewise called with dependant variable outside of range or Otherwise not provided."
        )
